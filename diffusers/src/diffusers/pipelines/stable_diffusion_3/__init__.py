...
try:
    ...
    _import_structure["pipeline_dense_stable_diffusion_3"] = ["DenseStableDiffusion3Pipeline"]
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_dense_stable_diffusion_3 import DenseStableDiffusion3Pipeline
else:
    import sys
