...
class DenseStableDiffusion3Pipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin):
    r"""
    Args:
    ...
    def _get_clip_prompt_embeds(
        ...
        return prompt_embeds, pooled_prompt_embeds, text_inputs
    ...
    def encode_prompt(
        ...
        layouts: Optional[torch.FloatTensor] = None,
        device: Optional[torch.device] = None,
        num_images_per_prompt: int = 1,
        ...
        if prompt_embeds is None:
            ...
            prompt_embed, pooled_prompt_embed, text_inputs = self._get_clip_prompt_embeds(
                prompt=prompt,
                device=device,
            ...
            if layouts is not None:
                ...
                for i in range(1,len(prompt)):
                    wlen = text_inputs['length'][i] - 2
                    widx = text_inputs['input_ids'][i][1:1+wlen]
                    for j in range(77):
            ...
            prompt_2_embed, pooled_prompt_2_embed, text_inputs_2 = self._get_clip_prompt_embeds(
                prompt=prompt_2,
                device=device,
                num_images_per_prompt=num_images_per_prompt,
                clip_skip=clip_skip,
            ...
            if layouts is not None:
                ...
                for i in range(1,len(prompt_2)):
                    wlen = text_inputs_2['length'][i] - 2
                    widx = text_inputs_2['input_ids'][i][1:1+wlen]
                    for j in range(77):
        ...
        if do_classifier_free_guidance and negative_prompt_embeds is None:
            ...
            negative_prompt_embed, negative_pooled_prompt_embed, negative_text_inputs = self._get_clip_prompt_embeds(
                negative_prompt,
                device=device,
                num_images_per_prompt=num_images_per_prompt,
                clip_skip=None,
            ...
            negative_prompt_2_embed, negative_pooled_prompt_2_embed, negative_text_inputs_2 = self._get_clip_prompt_embeds(
                negative_prompt_2,
                device=device,
                num_images_per_prompt=num_images_per_prompt,
                clip_skip=None,
        ...
        return prompt_embeds, negative_prompt_embeds, pooled_prompt_embeds, negative_pooled_prompt_embeds, creg_maps
    ...
    def __call__(
        ...
        Args:
            ...
            layouts (`torch.FloatTensor`, *optional*): The layouts of the prompts.
        Examples:
